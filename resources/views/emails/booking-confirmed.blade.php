                ...
                <table class="container" role="presentation" width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td class="content" style="padding:35px 30px;">
                            ...
                            @if($booking->notes)
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                                style="margin:20px 0 0;background:#f0fdf4;border-left:4px solid #16a34a;border-radius:6px;">
                            ...
                            <p style="margin:25px 0 0;color:#66736d;font-size:14px;line-height:1.8;">
                                Please arrive a few minutes before your scheduled appointment. If you need to make any
                                changes, kindly contact our clinic in advance. This is an automated email, and replies to
