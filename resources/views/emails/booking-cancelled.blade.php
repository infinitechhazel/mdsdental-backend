                    ...
                    <tr>
                        <td class="content" style="padding:35px 30px;">
                            ...
                            <p style="margin:0 0 25px;color:#333333;font-size:15px;line-height:1.7;">
                                Your appointment has been cancelled. We're sorry for any inconvenience this may have
                                caused. If this cancellation was made in error or you'd like to arrange another
                                appointment, our team will be happy to assist you.
                            </p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td class="value"
                                        style="padding:12px 0;color:#dc2626;font-size:14px;font-weight:bold;">
                                        Cancelled
                                    </td>
                                </tr>
                            ...
                            @if($booking->notes)
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                                style="margin:0 0 25px;background:#f0fdf4;border-left:4px solid #16a34a;border-radius:6px;">

                                <tr>
                                    <td style="padding:16px 18px;">

                                        <p
                                            style="margin:0 0 6px;color:#15803d;font-size:13px;font-weight:bold;text-transform:uppercase;">
                                            Message
                                        </p>
                            ...
                            <p style="margin:25px 0 0;color:#66736d;font-size:14px;line-height:1.8;">
                                If you would like to schedule another appointment, please use our online booking system or contact our clinic directly. This is an automated system-generated email. Please do not reply to this message.
