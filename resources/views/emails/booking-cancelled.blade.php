                ...
                <table class="container" role="presentation" width="100%" cellpadding="0" cellspacing="0"
                            ...
                            <table role="presentation" width="100%">
                                <tr class="mobile-stack">
                                    ...
                                    <td class="mobile-badge" align="right">
                                        <span
                                            style="display:inline-block;background:#111827;color:#ffffff;font-size:12px;font-weight:bold;padding:7px 14px;border-radius:30px;letter-spacing:.5px;">
                                            CANCELLED
                                        </span>
                                    </td>
                    ...
                    <tr>
                        <td class="content" style="padding:35px 30px;">
                            ...
                            @if($booking->notes)
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                                style="margin:25px 0;background:#f4f7ff;border-left:4px solid #1d4ed8;border-radius:6px;">
